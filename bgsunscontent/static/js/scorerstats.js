...
(function() {
    ...
    var textOffsetx = 65                    // Text Position offset from edge of bar (px)
    ...
    var colTextPrefix = "Game-"             // Column text prefix string
    
    var animationSpeed = 1750               // Overall Bar animation speed (ms)
    var delaySpeed = 50                     // Animation delay speed
    
    var JSONFile = "/static/js/scorerstats.json";         // JSON data file to load
    var team2Watch = ["Archie", "Pete"];    // Array of Initial teams to be tracked in selection box
    ...
    var seriesModel = "Cumulative"            // Set to "Cumulative" for Cumulative data sorting e.g. Goals. Set to "Regular" for position sorting
    ...
    function ready(error, datapoints) {
        ...
        g.selectAll(".image")
            ...
            .attr("xlink:href", function(d) {
                return "/static/images/" + d.team + ".jpg"
            })
            .attr("x", imagePosx)
            .attr("y", function(d) {
        ...
        d3.select("#weekBtn").on("click", function() {
            ...
            if (wNum >= totalWeeks) {                                           // No more data to display - execute the summary popup
                ...
                team2Watch.forEach(function (t,index) {
                    ...
                    d3.select("#team-image-"+ index.toString()).attr("src","images/" + t + ".jpg")
